...
#if defined(CONFIG_NET_ETHERNET_BRIDGE_VLAN_COUNT)
#define NET_ETHERNET_BRIDGE_VLAN_COUNT CONFIG_NET_ETHERNET_BRIDGE_VLAN_COUNT
#elif defined(CONFIG_NET_VLAN_COUNT)
#define NET_ETHERNET_BRIDGE_VLAN_COUNT CONFIG_NET_VLAN_COUNT
#else
#define NET_ETHERNET_BRIDGE_VLAN_COUNT NET_ETHERNET_BRIDGE_ETH_INTERFACE_COUNT
#endif
